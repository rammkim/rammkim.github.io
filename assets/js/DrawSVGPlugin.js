    ...
    function y(e) {
        ...
        if (
            ((r && (r.width || r.height)) ||
                ...
                ((r = { width: parseFloat(e.getAttribute('rect' === h ? 'width' : 'circle' === h ? 'r' : 'rx')), height: parseFloat(e.getAttribute('rect' === h ? 'height' : 'circle' === h ? 'r' : 'ry')) }), 'rect' !== h && ((r.width *= 2), (r.height *= 2))),
            'path' === h)
        )
        ...
        else if ('polyline' === h || 'polygon' === h) for (o = e.getAttribute('points').match(g) || [], 'polygon' === h && o.push(o[0], o[1]), t = 0, s = 2; s < o.length; s += 2) t += l(o[s - 2], o[s - 1], o[s], o[s + 1], f, d) || 0;
    ...
    ((e = _gsScope._gsDefine.plugin({
        ...
        init: function (e, t, r, o) {
            ...
            return (
                ...
                (f = u),
                (d = i[0]),
                -1 === (c = h.indexOf(' ')) ? ((g = void 0 !== d ? d + '' : h), (l = h)) : ((g = h.substr(0, c)), (l = h.substr(c + 1))),
                (g = -1 !== g.indexOf('%') ? (parseFloat(g) / 100) * f : parseFloat(g)),
                (s = (l = -1 !== l.indexOf('%') ? (parseFloat(l) / 100) * f : parseFloat(l)) < g ? [l, g] : [g, l]),
                (this._length = u + 10),
                0 === i[0] && 0 === s[0]
                    ? ((n = Math.max(1e-5, s[1] - u)), (this._dash = u + n), (this._offset = u - i[1] + n), (this._offsetPT = this._addTween(this, '_offset', this._offset, u - s[1] + n, 'drawSVG')))
                    : ((this._dash = i[1] - i[0] || 1e-6), (this._offset = -i[0]), (this._dashPT = this._addTween(this, '_dash', this._dash, s[1] - s[0] || 1e-5, 'drawSVG')), (this._offsetPT = this._addTween(this, '_offset', this._offset, -s[0], 'drawSVG'))),
                _ && (a = p(e)).strokeLinecap !== a.strokeLinejoin && ((s = parseFloat(a.strokeMiterlimit)), this._addTween(e.style, 'strokeMiterlimit', s, s + 1e-4, 'strokeMiterlimit')),
        ...
        set: function (e) {
            if (this._firstPT) {
                ...
                this._super.setRatio.call(this, e),
                    ...
                    (this._style.strokeDasharray = 1 === e || 0 === e ? (this._offset < 0.001 && this._length - this._dash <= 10 ? 'none' : this._offset === this._dash ? '0px, 999999px' : this._dash + 'px,' + this._length + 'px') : this._dash + 'px,' + this._length + 'px');
            }
        }
    })).getLength = y),
        (e.getPosition = x);
