                ...
                (_.render = function (t, e, i) {
                    ...
                    if (
                        (t >= f
                            ? ((this._totalTime = f),
                              ...
                              0 === g && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > v || v === a) && v !== t && ((i = !0), v > a && (r = 'onReverseComplete')), (this._rawPrevTime = c = !e || t || v === t ? t : a)))
                            : 1e-7 > t
                            ? ((this._totalTime = this._time = this._cycle = 0),
                              (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                              (0 !== m || (0 === g && v > 0)) && ((r = 'onReverseComplete'), (s = this._reversed)),
                              0 > t && ((this._active = !1), 0 === g && (this._initted || !this.vars.lazy || i) && (v >= 0 && (i = !0), (this._rawPrevTime = c = !e || t || v === t ? t : a))),
                              this._initted || (i = !0))
                    ...
                    for (
                        this._lazy !== !1 && (this._lazy = !1),
                            ...
                            0 === m && (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = '_dummyGS')), this.vars.onStart && (0 !== this._totalTime || 0 === g) && (e || this._callback('onStart'))),
                            n = this._firstPT;
                        n;
            ...
            return (
                ...
                (n.globalTimeScale = function (e) {
                    ...
                    return arguments.length
                        ? ((e = e || a), (s._startTime = r - ((r - s._startTime) * s._timeScale) / e), (s = t._rootFramesTimeline), (r = i.ticker.frame), (s._startTime = r - ((r - s._startTime) * s._timeScale) / e), (s._timeScale = t._rootTimeline._timeScale = e), e)
                        : s._timeScale;
                }),
                    ...
                    (d.render = function (t, e, i) {
                        ...
                        if (t >= c)
                            (this._totalTime = this._time = c),
                                this._reversed ||
                                    ...
                                    0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && ((l = !0), this._rawPrevTime > r && (o = 'onReverseComplete'))),
                        ...
                        if ((this._time !== f && this._first) || i || l || u) {
                            ...
                            this._onUpdate && (e || (h.length && _(), this._callback('onUpdate'))),
                                o &&
                                    (this._gc ||
                                        ((p === this._startTime || m !== this._timeScale) && (0 === this._time || c >= this.totalDuration()) && (n && (h.length && _(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[o] && this._callback(o))));
                        }
                    }),
                    ...
                    (h.render = function (t, e, i) {
                        ...
                        if ((this._initted || (this._initted = !0), this._active || (!this._paused && this._totalTime !== d && t > 0 && (this._active = !0)), 0 === d && this.vars.onStart && 0 !== this._totalTime && (e || this._callback('onStart')), this._time >= m))
                            for (s = this._first; s && ((l = s._next), !this._paused || T); )
                                (s._active || (s._startTime <= this._time && !s._paused && !s._gc)) && (c === s && this.pause(), s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)),
                                    (s = l);
                        else
                        ...
                        this._onUpdate && (e || (a.length && o(), this._callback('onUpdate'))),
                            h &&
                                (this._locked ||
                                    this._gc ||
                                    ((g === this._startTime || v !== this._timeScale) && (0 === this._time || f >= this.totalDuration()) && (n && (a.length && o(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[h] && this._callback(h))));
                    }),
                ...
                h = function (t, r, n, a, o) {
                    ...
                    for (h = 0; w > h; h++)
                        (f = t[b]),
                            ...
                            (c = t[b + 1].d),
                            o
                                ? ((y = e[h]), (T = i[h]), (x = (0.25 * (T + y) * r) / (a ? 0.5 : s[h] || 0.5)), (p = u - (u - _) * (a ? 0.5 * r : 0 !== y ? x / y : 0)), (m = u + (c - u) * (a ? 0.5 * r : 0 !== T ? x / T : 0)), (d = u - (p + (((m - p) * ((3 * y) / (y + T) + 0.5)) / 4 || 0))))
            ...
            function (t, e) {
                    ...
                    J = function (t, e, i, s, r) {
                        ...
                        for (a in i)
                            'cssText' !== a &&
                                ...
                                ((l[a] = 'auto' !== n || ('left' !== a && 'top' !== a) ? (('' !== n && 'auto' !== n && 'none' !== n) || 'string' != typeof e[a] || '' === e[a].replace(y, '') ? n : 0) : H(t, a)), void 0 !== h[a] && (o = new pe(h, a, h[a], o)));
                    ...
                    he = (a.parseColor = function (t, e) {
                        ...
                        return (
                            e &&
                                ...
                                (_ = Math.min(s, r, n)),
                                (l = (h + _) / 2),
                                h === _ ? (a = o = 0) : ((u = h - _), (o = l > 0.5 ? u / (2 - h - _) : u / (h + _)), (a = h === s ? (r - n) / u + (n > r ? 6 : 0) : h === r ? (n - s) / u + 2 : (s - r) / u + 4), (a *= 60)),
                                (i[0] = 0 | (a + 0.5)),
                                (i[1] = 0 | (100 * o + 0.5)),
                                (i[2] = 0 | (100 * l + 0.5))),
                            i
                        ...
                        return (
                            ...
                            i || 0 === o || a.plugin
                                ? (a.l++,
                                  ...
                                  (a['xs' + a.l] = s || ''),
                                  o > 0 ? ((a.data['xn' + o] = e + i), (a.rxp['xn' + o] = r), (a['xn' + o] = e), a.plugin || ((a.xfirst = new me(a, 'xn' + o, e, i, a.xfirst || a, 0, a.n, r, a.pr)), (a.xfirst.xs0 = 0)), a) : ((a.data = { s: e + i }), (a.rxp = {}), (a.s = e), (a.c = i), (a.r = r), a))
                                : ((a['xs' + o] += e + (s || '')), a)
                        );
                    });
                var ye = function (t, e) {
                ...
                var we,
                    ...
                    Me = (function () {
                        ...
                        return (
                            E.createElementNS &&
                                !s &&
                                ((t = Ce('svg', De)), (e = Ce('rect', t, { width: 100, height: 50, x: 100 })), (i = e.getBoundingClientRect().width), (e.style[Se] = '50% 50%'), (e.style[Pe] = 'scaleX(0.5)'), (s = i === e.getBoundingClientRect().width && !(f && Re)), De.removeChild(t)),
                            s
                        );
                    })(),
                    ze = function (t, e, i, s, r) {
                        ...
                        T && ((v = T.xOrigin), (y = T.yOrigin)),
                            (!s || 2 > (n = s.split(' ')).length) &&
                                ((c = t.getBBox()), (e = se(e).split(' ')), (n = [(-1 !== e[0].indexOf('%') ? (parseFloat(e[0]) / 100) * c.width : parseFloat(e[0])) + c.x, (-1 !== e[1].indexOf('%') ? (parseFloat(e[1]) / 100) * c.height : parseFloat(e[1])) + c.y])),
                            (i.xOrigin = h = parseFloat(n[0])),
                            (i.yOrigin = _ = parseFloat(n[1])),
                            s &&
                                x !== Ie &&
                                ((u = x[0]), (c = x[1]), (f = x[2]), (p = x[3]), (m = x[4]), (d = x[5]), (g = u * p - c * f), (o = h * (p / g) + _ * (-f / g) + (f * d - p * m) / g), (l = h * (-c / g) + _ * (u / g) - (u * d - c * m) / g), (h = i.xOrigin = n[0] = o), (_ = i.yOrigin = n[1] = l)),
                    ...
                    Ee = function (t, e) {
                        var i,
                            ...
                            l = 1e5;
                        if (
                            (Pe ? (s = Q(t, ke, null, !0)) : t.currentStyle && ((s = t.currentStyle.filter.match(C)), (s = s && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), o.x || 0, o.y || 0].join(',') : '')),
                    ...
                    Le = function (t) {
                        ...
                        if (c) {
                            ...
                            if (
                                (null != s.ox && ((f = (s.oxp ? 0.01 * d * s.ox : s.ox) - d / 2), (p = (s.oyp ? 0.01 * g * s.oy : s.oy) - g / 2), (w += f - (f * o + p * l)), (b += p - (f * h + p * _))),
                                v ? ((f = d / 2), (p = g / 2), (y += ', Dx=' + (f - (f * o + p * l) + w) + ', Dy=' + (p - (f * h + p * _) + b) + ')')) : (y += ", sizingMethod='auto expand')"),
                            ...
                            function (t) {
                                        ...
                                        R || k.skewX || N
                                            ? ((R *= z),
                                              ...
                                              N &&
                                                  ...
                                                  we && (k.xPercent || k.yPercent) && ((m = this.t.getBBox()), (F += 0.01 * k.xPercent * m.width), (I += 0.01 * k.yPercent * m.height)),
                                                  (m = 1e-6),
                                                  m > F && F > -m && (F = 0),
                                                  m > I && I > -m && (I = 0)),
                                              (T = (0 | (e * P)) / P + ',' + (0 | (r * P)) / P + ',' + (0 | (i * P)) / P + ',' + (0 | (n * P)) / P + ',' + F + ',' + I + ')'),
                                              N && we ? this.t.setAttribute('transform', 'matrix(' + T) : (S[Pe] = (k.xPercent || k.yPercent ? 'translate(' + k.xPercent + '%,' + k.yPercent + '%) matrix(' : 'matrix(') + T))
                                ...
                                (h = 1),
                                    ...
                                    (p || N) &&
                                        ...
                                        N && ((F += k.xOrigin - (k.xOrigin * e + k.yOrigin * i) + k.xOffset), (I += k.yOrigin - (k.xOrigin * r + k.yOrigin * n) + k.yOffset)),
                                        m > F && F > -m && (F = w),
                                        m > I && I > -m && (I = w),
                                        m > E && E > -m && (E = 0)),
                ...
                (h = Oe.prototype),
                            ...
                            parser: function (t, e, i, s, n, o, l) {
                                ...
                                if ((l.display ? ((c = Q(t, 'display')), (T.display = 'block'), (h = Ne(t, r, !0, l.parseTransform)), (T.display = c)) : (h = Ne(t, r, !0, l.parseTransform)), (s._transform = h), 'string' == typeof b.transform && Pe))
                                    ...
                                    'string' == typeof b.x && -1 !== b.x.indexOf('%') && ((_.x = 0), (_.xPercent = ne(b.x, h.xPercent))),
                                        ...
                                        Re &&
                                            ((_.rotationX = ae('rotationX' in b ? b.rotationX : 'shortRotationX' in b ? b.shortRotationX + '_short' : h.rotationX || 0, h.rotationX, 'rotationX', P)),
                                ...
                                return (
                                    ...
                                    h.svg &&
                                        ...
                                        (g !== h.xOffset || v !== h.yOffset) && ((n = de(h, 'xOffset', y ? g : h.xOffset, h.xOffset, n, k)), (n = de(h, 'yOffset', y ? v : h.yOffset, h.yOffset, n, k))),
                                        (f = we ? null : '0px 0px')),
                                    (f || (Re && p && h.zOrigin)) &&
                                        (Pe
                                            ? ((m = !0),
                    ...
                    Te('clip', {
                        ...
                        parser: function (t, e, i, s, n, a) {
                            var o, l, h;
                            return (
                                9 > m ? ((l = t.currentStyle), (h = 8 > m ? ' ' : ','), (o = 'rect(' + l.clipTop + h + l.clipRight + h + l.clipBottom + h + l.clipLeft + ')'), (e = this.format(e).split(',').join(h))) : ((o = this.format(Q(t, this.p, r, !1, this.dflt))), (e = this.format(e))),
                    ...
                    parser: function (t, e, i, s, n, a) {
                        ...
                        return (
                            ...
                            Y
                                ...
                                : ((n = new me(l, 'opacity', 100 * o, 100 * (e - o), n)), (n.xn1 = h ? 1 : 0), (l.zoom = 1), (n.type = 2), (n.b = 'alpha(opacity=' + n.s + ')'), (n.e = 'alpha(opacity=' + (n.s + n.c) + ')'), (n.data = t), (n.plugin = a), (n.setRatio = Be)),
                ...
                (h = a.prototype),
                    ...
                    (h._onInitTween = function (t, e, o) {
                        ...
                        if (
                            ...
                            'string' == typeof e && ((d = b.cssText), (h = K(t, r)), (b.cssText = d + ';' + e), (h = J(t, h, K(t)).difs), !Y && w.test(e) && (h.opacity = parseFloat(RegExp.$1)), (e = h), (b.cssText = d)),
                            ...
                            for (
                                x = 3 === this._transformType,
                                    Pe
                                        ? c && ((u = !0), '' === b.zIndex && ((y = Q(t, 'zIndex', r)), ('auto' === y || '' === y) && this._addLazySet(b, 'zIndex', 0)), p && this._addLazySet(b, 'WebkitBackfaceVisibility', this._vars.WebkitBackfaceVisibility || (x ? 'visible' : 'hidden')))
                                        : (b.zoom = 1),
                                    m = f;
                                m && m._next;
                                      ...
                                      'color' === a || 'fill' === a || 'stroke' === a || -1 !== a.indexOf('Color') || (d && P.test(f))
                                          ...
                                          ? ((h = parseFloat(c)),
                                            ...
                                            p !== m &&
                                                ...
                                                (u || 0 === u) &&
                                                h &&
                                                ((h = $(t, a, h, p)), '%' === m ? ((h /= $(t, a, 100, '%') / 100), e.strictUnits !== !0 && (c = h + '%')) : 'em' === m || 'rem' === m ? (h /= $(t, a, 1, m)) : 'px' !== m && ((u = $(t, a, u, m)), (m = 'px')), g && (u || 0 === u) && (f = u + h + m)),
                                            g && (u += h),
                                            (!h && 0 !== h) || (!u && 0 !== u)
                                                ? void 0 !== v[a] && (f || ('NaN' != f + '' && null != f))
                                                    ? ((i = new me(v, a, u || h || 0, 0, i, -1, a, !1, 0, c, f)), (i.xs0 = 'none' !== f || ('display' !== a && -1 === a.indexOf('Style')) ? f : c))
                ...
                (h._addLazySet = function (t, e, i) {
                    ...
                    (h._kill = function (e) {
                        ...
                        return (
                            e.className && (i = this._classNamePT) && ((r = i.xfirst), r && r._prev ? this._linkCSSP(r._prev, i._next, r._prev._prev) : r === this._firstPT && (this._firstPT = i._next), i._next && this._linkCSSP(i._next, i._next._next, r._prev), (this._classNamePT = null)),
            ...
            function (t) {
                ...
                return (
                    ...
                    (i = l(
                        ...
                        function (e) {
                            e = e || {};
                            for (var i, s, r, n, a, o, l = e.taper || 'none', h = [], _ = 0, u = 0 | (e.points || 20), f = u, p = e.randomize !== !1, m = e.clamp === !0, d = e.template instanceof t ? e.template : null, g = 'number' == typeof e.strength ? 0.4 * e.strength : 0.4; --f > -1; )
                                (i = p ? Math.random() : (1 / u) * f),
                                    (s = d ? d.getRatio(i) : i),
                                    'none' === l ? (r = g) : 'out' === l ? ((n = 1 - i), (r = n * n * g)) : 'in' === l ? (r = i * i * g) : 0.5 > i ? ((n = 2 * i), (r = 0.5 * n * n * g)) : ((n = 2 * (1 - i)), (r = 0.5 * n * n * g)),
        ...
        if (!i.TweenLite) {
                                    ...
                                    n
                                        ? 'string' != typeof n
                                            ? n.length && n !== t && n[0] && (n[0] === t || (n[0].nodeType && n[0].style && !n.nodeType))
                                                ...
                                                : ((this._siblings[r] = $(n, this, !1)), 1 === l && this._siblings[r].length > 1 && K(n, this, null, 1, this._siblings[r]))
            ...
            var F = [],
                ...
                L = function (t, e, i, s) {
                    ...
                    for (u.start = t, i && (i(u), (t = u[0]), (e = u[1])), u.length = 0, r = t.match(E) || [], n = e.match(E) || [], s && ((s._next = null), (s.blob = 1), (u._firstPT = s)), l = n.length, o = 0; l > o; o++)
                        (_ = n[o]),
                            ...
                            _ === r[o] || o >= r.length
                                ? (f += _)
                                : (f && (u.push(f), (f = '')), (a = parseFloat(r[o])), u.push(a), (u._firstPT = { _next: u._firstPT, t: u, p: u.length - 1, s: a, c: ('=' === _.charAt(1) ? parseInt(_.charAt(0) + '1', 10) * parseFloat(_.substr(2)) : parseFloat(_) - a) || 0, f: 0, r: p && 4 > p })),
                            (c += _.length);
                ...
                X = function (t, e, i, s, r, n, a, o) {
                    ...
                    return (
                        'number' !== u &&
                            ('function' === u && 'get' === i && ((h = e.indexOf('set') || 'function' != typeof t['get' + e.substr(3)] ? e : 'get' + e.substr(3)), (f.s = _ = a ? t[h](a) : t[h]())),
                            'string' == typeof _ && (a || isNaN(_)) ? ((f.fp = a), (l = L(_, s, o || D.defaultStringFilter, f)), (f = { t: l, p: 'setRatio', s: 0, c: 1, f: 2, pg: 0, n: r || e, pr: 0 })) : c || (f.c = parseFloat(s) - parseFloat(_) || 0)),
                ...
                K = function (t, e, i, s, r) {
                    ...
                    for (n = r.length; --n > -1; )
                        (o = r[n]) === e ||
                            o._gc ||
                            o._paused ||
                            (o._timeline !== e._timeline ? ((h = h || J(e, 0, p)), 0 === J(o, h, p) && (c[f++] = o)) : u >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > u && (((p || !o._initted) && 2e-10 >= u - o._startTime) || (c[f++] = o)));
                    for (n = f; --n > -1; )
            ...
            (n._init = function () {
                ...
                if (
                    ((this._ease = h = h ? (h instanceof T ? h : 'function' == typeof h ? new T(h, n.easeParams) : x[h] || D.defaultEase) : D.defaultEase),
                ...
                (n._initProps = function (e, i, s, r) {
                    ...
                    return r && this._kill(r, e)
                        ...
                        : (this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)) && (I[e._gsTweenID] = !0), o);
                }),
                (n.render = function (t, e, i) {
                    var s,
                        r,
                    ...
                    if (t >= l)
                        (this._totalTime = this._time = l),
                            ...
                            0 === l &&
                                ...
                                (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > h || (h === _ && 'isPause' !== this.data)) && h !== t && ((i = !0), h > _ && (r = 'onReverseComplete')), (this._rawPrevTime = a = !e || t || h === t ? t : _));
                    else if (1e-7 > t)
                    ...
                    if (this._time !== o || i) {
                        ...
                        for (
                            this._lazy !== !1 && (this._lazy = !1),
                                ...
                                0 === o && (this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = '_dummyGS')), this.vars.onStart && (0 !== this._time || 0 === l) && (e || this._callback('onStart'))),
                                n = this._firstPT;
                            n;
