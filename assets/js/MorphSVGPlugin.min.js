...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function R(e) {
        ...
        for (r = 0; r < y; r++)
            if (((u = a), isNaN(d[r]) ? (h = (a = d[r].toUpperCase()) !== d[r]) : r--, (n = +d[r + 1]), (i = +d[r + 2]), h && ((n += _), (i += C)), r || ((l = n), (f = i)), 'M' === a))
                s && (s.length < 8 ? --m.length : (S += s.length)), (_ = l = n), (C = f = i), (s = [n, i]), m.push(s), (r += 2), (a = 'L');
            ...
            else if ('L' === a || 'Z' === a) 'Z' === a && ((n = l), (i = f), (s.closed = !0)), ('L' === a || 0.5 < Math.abs(_ - n) || 0.5 < Math.abs(C - i)) && (t(_, C, n, i), 'L' === a && (r += 2)), (_ = n), (C = i);
            else if ('A' === a) {
                if (
                    (c = (function (e, t, r, o, n, i, a, h, s) {
                        if (e !== h || t !== s) {
                            ...
                            for (var G = Math.ceil(Math.abs(L) / (Z / 4)), I = [], F = L / G, Y = ((4 / 3) * E(F / 2)) / (1 + Q(F / 2)), j = f * r, B = g * r, V = g * -o, X = f * o, D = 0; D < G; D++)
                                (u = Q((n = O + D * F))), (d = E(n)), (N = Q((n += F))), (P = E(n)), I.push(u - Y * d, d + Y * u, N + Y * P, P - Y * N, N, P);
    ...
    function L(e, t) {
        ...
        for (var r, o, n, i, a, h, s, l, f, g, p, c, u, d, m, _, C = e.length, y = e[0][0], S = y, v = e[0][1], x = v, w = 1 / t; -1 < --C; )
            for (r = (a = e[C]).length, i = 6; i < r; i += 6)
                for (f = a[i], g = a[i + 1], p = a[i + 2] - f, d = a[i + 3] - g, c = a[i + 4] - f, m = a[i + 5] - g, u = a[i + 6] - f, _ = a[i + 7] - g, h = t; -1 < --h; )
                    y < (o = ((s = w * h) * s * u + 3 * (l = 1 - s) * (s * c + l * p)) * s + f) ? (y = o) : o < S && (S = o), v < (n = (s * s * _ + 3 * l * (s * m + l * d)) * s + g) ? (v = n) : n < x && (x = n);
                    ...
                    c.splice(
                        ...
                        (function (e, t, r, o, n, i) {
                            for (var a, h, s, l = t.length, f = 0, g = Math.min(e.size || M(e), t[r].size || M(t[r])) * o, p = 1e20, c = e.centerX + n, u = e.centerY + i, d = r; d < l && !((t[d].size || M(t[d])) < g); d++)
                                (a = t[d].centerX - c), (h = t[d].centerY - u), (s = W(a * a + h * h)) < p && ((f = d), (p = s));
                            return (s = t[f]), t.splice(f, 1), s;
                        })(u[C], c, C, _, f, g)
                    );
            if (p)
                for (p < 0 && (p = -p), c[0].length > u[0].length && x(u[0], ((c[0].length - u[0].length) / 6) | 0), C = u.length; d < p; )
                    c[C].size || M(c[C]),
                        (s = (h = (function (e, t, r) {
                            for (var o, n, i, a, h, s, l = e.length, f = 1e20, g = 0, p = 0; -1 < --l; ) for (s = (o = e[l]).length, h = 0; h < s; h += 6) (n = o[h] - t), (i = o[h + 1] - r), (a = W(n * n + i * i)) < f && ((f = a), (g = o[h]), (p = o[h + 1]));
                            return [g, p];
                            ...
                            ? 'auto' === r || 'log' === r
                                ? ((y[C] = r =
                                      (function (e, t, r) {
                                          ...
                                          if (r) for (o = e.slice(0), w(o), p = 6; p < i; p += 6) (n = z(o, t, p / 6, s, l)) < f && ((f = n), (g = -p));
                                          return g / 6;
                                      })(a, i, !C || !1 === n)),
                                  r < 0 && ((S = !0), w(a), (r = -r)),
                                  P(a, 6 * r))
                                : 'reverse' !== r && (C && r < 0 && w(a), P(a, 6 * (r < 0 ? -r : r)))
                            : !S &&
                              (('auto' === r &&
    ...
    function n(e, t) {
        for (var r, o, n, i, a = 0, h = parseFloat(e[0]), s = parseFloat(e[1]), l = h + ',' + s + ' ', f = e.length, g = (0.5 * t) / (0.5 * f - 1), p = 0; p < f - 2; p += 2) {
            if (((a += g), (n = parseFloat(e[p + 2])), (i = parseFloat(e[p + 3])), 0.999999 < a)) for (o = 1 / (Math.floor(a) + 1), r = 1; 0.999999 < a; ) (l += (h + (n - h) * o * r).toFixed(2) + ',' + (s + (i - s) * o * r).toFixed(2) + ' '), a--, r++;
            (l += n + ',' + i + ' '), (h = n), (s = i);
        }
        return l;
    }
    ...
    function a(e, t) {
        ...
        return 'path' !== b && e.getBBox
            ? ((h = (function (e, t) {
                  var r,
                      o = _gsScope.document.createElementNS('http://www.w3.org/2000/svg', 'path'),
                    ...
                    (r =
                        i || a
                            ? 'M' +
                              ...
                              'z'
                            : 'M' + (o + g) + ',' + n + ' v' + p + ' h' + -g + ' v' + -p + ' h' + g + 'z'))
                  : 'circle' === b || 'ellipse' === b
                  ? ((l = 'circle' === b ? (i = a = w.r) * M : ((i = w.rx), (a = w.ry) * M)),
                    (r = 'M' + ((o = w.cx) + i) + ',' + (n = w.cy) + ' C' + [o + i, n + l, o + (s = i * M), n + a, o, n + a, o - s, n + a, o - i, n + l, o - i, n, o - i, n - l, o - s, n - a, o, n - a, o + s, n - a, o + i, n - l, o + i, n].join(',') + 'z'))
                  : 'line' === b
                  ? (r = 'M' + w.x1 + ',' + w.y1 + ' L' + w.x2 + ',' + w.y2)
                  : ('polyline' !== b && 'polygon' !== b) || ((r = 'M' + (o = (f = (e.getAttribute('points') + '').match(X) || []).shift()) + ',' + (n = f.shift()) + ' L' + f.join(',')), 'polygon' === b && (r += ',' + o + ',' + n + 'z')),
              h.setAttribute('d', O((h._gsRawPath = R(r)))),
              t && e.parentNode && (e.parentNode.insertBefore(h, e), e.parentNode.removeChild(e)),
              h)
            : e;
    }
    function F(e, t, r) {
        ...
        return (
            (!i || h.test(e) || (e.match(X) || []).length < 3) &&
                ((o = i ? p.selector(e) : e && e[0] ? e : [e]) && o[0]
                    ? ((n = ((o = o[0]).nodeName + '').toUpperCase()), t && 'PATH' !== n && ((o = a(o, !1)), (n = 'PATH')), (e = o.getAttribute('PATH' === n ? 'd' : 'points') || ''), o === r && (e = o.getAttributeNS(null, 'data-original') || e))
                    : (A('WARNING: invalid morph to: ' + e), (e = !1))),
            e
        );
    }
    function Y(e, t) {
        for (var r, o, n, i, a, h, s, l, f, g, p, c, u = e.length, d = 0.2 * (t || 1); -1 < --u; ) {
            for (p = (o = e[u]).isSmooth = o.isSmooth || [0, 0, 0, 0], c = o.smoothData = o.smoothData || [0, 0, 0, 0], p.length = 4, l = o.length - 2, s = 6; s < l; s += 6)
                (n = o[s] - o[s - 2]), (i = o[s + 1] - o[s - 1]), (a = o[s + 2] - o[s]), (h = o[s + 3] - o[s + 1]), (f = y(i, n)), (g = y(h, a)), (r = Math.abs(f - g) < d) && ((c[s - 2] = f), (c[s + 2] = g), (c[s - 1] = W(n * n + i * i)), (c[s + 3] = W(a * a + h * h))), p.push(r, r, 0, 0, r, r);
            o[l] === o[0] &&
                o[1 + l] === o[1] &&
                ((n = o[0] - o[l - 2]), (i = o[1] - o[l - 1]), (a = o[2] - o[0]), (h = o[3] - o[1]), (f = y(i, n)), (g = y(h, a)), Math.abs(f - g) < d && ((c[l - 2] = f), (c[2] = g), (c[l - 1] = W(n * n + i * i)), (c[3] = W(a * a + h * h)), (p[l - 2] = p[l - 1] = !0)));
        }
        return e;
    }
    function j(e) {
        var t = e.trim().split(' ');
        return { x: (0 <= e.indexOf('left') ? 0 : 0 <= e.indexOf('right') ? 100 : isNaN(parseFloat(t[0])) ? 50 : parseFloat(t[0])) / 100, y: (0 <= e.indexOf('top') ? 0 : 0 <= e.indexOf('bottom') ? 100 : isNaN(parseFloat(t[1])) ? 50 : parseFloat(t[1])) / 100 };
    }
    var B,
        H = Math.PI,
        U = H / 180,
            ...
            for (
                var t = -1 !== (window ? window.location.href : '').indexOf(String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107)) && -1 !== e.indexOf(String.fromCharCode(108, 111, 99, 97, 108, 104, 111, 115, 116)),
                    r = [
                        ...
                        String.fromCharCode(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
                        String.fromCharCode(112, 101, 110, 115, 46, 99, 108, 111, 117, 100),
                        String.fromCharCode(112, 101, 110, 115, 46, 105, 111),
                        String.fromCharCode(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
        ...
        ee = { rect: 'rx,ry,x,y,width,height', circle: 'r,cx,cy', ellipse: 'rx,ry,cx,cy', line: 'x1,x2,y1,y2' },
        ...
        re = _gsScope._gsDefine.plugin({
            ...
            init: function (e, t, r, o) {
                ...
                if (((i = 'PATH' === n ? 'd' : 'points'), ('string' == typeof t || t.getBBox || t[0]) && (t = { shape: t }), !t.prop && 'function' != typeof e.setAttribute)) return !1;
                ...
                if (
                    ...
                    if (((this._target = e), (S = 'object' == typeof t.precompile), (c = this._prop ? e[this._prop] : e.getAttribute(i)), this._prop || e.getAttributeNS(null, 'data-original') || e.setAttributeNS(null, 'data-original', c), 'd' == i || this._prop)) {
                        ...
                        for (
                            ('log' !== t.precompile && !0 !== t.precompile) || A('precompile:["' + O(c) + '","' + O(u) + '"]'),
                                (b = 'linear' !== (t.type || re.defaultType)) &&
                                    ...
                                    u.size || L(u),
                                    (w = j(z[0])),
                                    (this._origin = c.origin = { x: c.left + w.x * c.width, y: c.top + w.y * c.height }),
                                    z[1] && (w = j(z[1])),
                                    (this._eOrigin = { x: u.left + w.x * u.width, y: u.top + w.y * u.height })),
                                m = (this._rawPath = e._gsRawPath = c).length;
                            -1 < --m;

                        )
                            for (C = c[m], y = u[m], g = C.isSmooth || [], p = y.isSmooth || [], _ = C.length, d = B = 0; d < _; d += 2)
                                (y[d] === C[d] && y[d + 1] === C[d + 1]) ||
                                    (b
                                        ? g[d] && p[d]
                                            ? ((v = C.smoothData),
                                              (x = y.smoothData),
                                              (M = d + (d === _ - 4 ? 7 - _ : 5)),
                                              (this._controlPT = { _next: this._controlPT, i: d, j: m, l1s: v[d + 1], l1c: x[d + 1] - v[d + 1], l2s: v[M], l2c: x[M] - v[M] }),
                                              (a = this._tweenRotation(C, y, d + 2)),
                                              this._tweenRotation(C, y, d, a),
                                              this._tweenRotation(C, y, M - 1, a),
                                              (d += 4))
                                            : this._tweenRotation(C, y, d)
                                        : ((a = this._addTween(C, d, C[d], y[d])), (a = this._addTween(C, d + 1, C[d + 1], y[d + 1]) || a)));
            ...
            set: function (e) {
                var t,
                    ...
                    _ = this._rnd,
                    C = this._target;
                if ((this._super.setRatio.call(this, e), 1 === e && this._apply)) for (o = this._firstPT; o; ) o.end && (this._prop ? (C[this._prop] = o.end) : C.setAttribute(o.endProp, o.end)), (o = o._next);
                else if (u) {
                    ...
                    if (((C._gsRawPath = u), this._apply)) {
                        for (t = '', s = 0; s < u.length; s++) for (i = (n = u[s]).length, t += 'M' + ((n[0] * _) | 0) / _ + ' ' + ((n[1] * _) | 0) / _ + ' C', h = 2; h < i; h++) t += ((n[h] * _) | 0) / _ + ' ';
    ...
    (re.prototype._tweenRotation = function (e, t, r, o) {
        ...
        return !o && B && Math.abs(p + B.ca) < c && (o = B), (this._anchorPT = B = { _next: this._anchorPT, t: e, sa: f, ca: o && p * o.ca < 0 && Math.abs(p) > u ? g : p, sl: l, cl: W(h * h + s * s) - l, i: r });
    }),
        ...
        (re.pathDataToBezier = function (e, t) {
            ...
            if (
                ('relative' === s || !0 === s
                    ? ((f -= a[0] * l[0] + a[1] * l[2]), (g -= a[0] * l[1] + a[1] * l[3]), (h = '+='))
                    : ((f += l[4]), (g += l[5]), (s = s && ('string' == typeof s ? p.selector(s) : s && s[0] ? s : [s])) && s[0] && ((f -= (i = s[0].getBBox() || { x: 0, y: 0 }).x), (g -= i.y))),
                (r = []),
                (n = a.length),
                l && '1,0,0,1,0,0' !== l.join(','))
            )
                for (o = 0; o < n; o += 2) r.push({ x: h + (a[o] * l[0] + a[o + 1] * l[2] + f), y: h + (a[o] * l[1] + a[o + 1] * l[3] + g) });
            else for (o = 0; o < n; o += 2) r.push({ x: h + (a[o] + f), y: h + (a[o + 1] + g) });
            return r;
        });
}),
